...
list.files(path = "../data/surface_water")
```
...
```{r}
waterSP <- readOGR(dsn = "../data/surface_water/OpenMap_Local_OS_SurfaceWater_Area.shp", verbose = TRUE)

water <- rasterize(x = waterSP, y = elev, getCover = TRUE)
```
