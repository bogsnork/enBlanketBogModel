...
```{r}
# model
load("../data/models/Mrf5final.rds")
Model <- M.rf.5.final 
rm(M.rf.5.final)
...
```{r}
output <- raster::predict(predictors, Model, type="raw", progress="text", response = "vote")

writeRaster(x = output, filename = "../outputs/BlanketBogRFModel5b.tif")
