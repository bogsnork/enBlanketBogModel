...
```{r}
# model
#load("../data/models/Mrf7final.rds")
#Model <- M.rf.10a.final 
...
```{r}
output <- raster::predict(predictors, Model, type="prob", progress="text", 
                          response = "vote", index = 2)

writeRaster(x = output, filename = "../outputs/BlanketBogRFModel10a.tif", overwrite = TRUE)
